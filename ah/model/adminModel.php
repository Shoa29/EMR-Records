...
require ("entities/notificationEntity.php");
...
class adminModel 
{
        ...
        function loginAdmin($username, $pwd)
    {
        ...
        Print '<script>window.location.assign("alogin.php");</script>'; // redirects to login.php
    ...
    function docEntry($userid, $content)
      ...
      $query= sprintf("INSERT INTO documents
                        (userid , content , temp1, temp2 )
                        VALUES
                        ('%s','%s','%s','%s')",
                   $userid,
                   $content,
      ...
      function  getNotificationsByUsername($username){
       ...
       {   
           ...
           $notification = new notificationEntity($id, $username, $content, $seen, $temp1, $temp2);

				...
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
						...
						<form class="row login_form" action="#/" id="register_form" >
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="fathername" name="txtFname" placeholder="Father Name" onfocus="this.placeholder = " " onblur="this.placeholder = " Father Name" ">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="mothername" name="txtMname" placeholder="Mother Name" onfocus="this.placeholder = " " onblur="this.placeholder = " mother Name" ">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="address" name="txtAddress" placeholder="Address" onfocus="this.placeholder = " " onblur="this.placeholder = " Address" ">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="phone number" name="txtPhone" placeholder="Contact Number" onfocus="this.placeholder = " " onblur="this.placeholder = " Contact Number" ">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="email" name="txtEmail" placeholder="E-Mail" onfocus="this.placeholder = " " onblur="this.placeholder = " E-mail" ">
							</div>
